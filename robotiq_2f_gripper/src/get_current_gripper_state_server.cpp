#include "robotiq_2f_gripper_control/get_current_gripper_state_server.h"
...
namespace robotiq_2f_gripper_control
{
  ...
  GetCurrentGripperStateServer::GetCurrentGripperStateServer() :  Node("get_gripper_state_server")
  {
    ...
    get_current_gripper_state_server_ = this->create_service<robotiq_2f_gripper_msgs::srv::GetCurrentGripperState>("~/gripper_state", 
  ...
  bool GetCurrentGripperStateServer::get_current_gripper_state_service(const std::shared_ptr<robotiq_2f_gripper_msgs::srv::GetCurrentGripperState::Request> req,
...
int main(int argc, char **argv)
{
  ...
  rclcpp::spin(std::make_shared<robotiq_2f_gripper_control::GetCurrentGripperStateServer>());
  rclcpp::shutdown();
}